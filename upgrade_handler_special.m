...
@implementation upgrade_handler_special
...
+(void)InitializeSpecialUpgrade:(UIScrollView*)s ID:(int)ID yPos:(int)y{
    ...
    backImage.image = [UIImage imageNamed:@"upgradeBarSpecial"];
    ...
    [upgrades_special addUpgrade:ID upgradeImage:upgradeImage upgradeText:infoText];
    [upgrades_special fetchMoneyValue:ID moneyTextBox:moneyText];
...
+(void)buttonAction:(id)sender{
    ...
    [upgrades_special fetchMoneyValue:newID moneyTextBox:moneyText];
    ...
    if(moneyVal >= unlockVal){
        ...
        [upgrades_special fetchMoneyValue:newID moneyTextBox:moneyText];
        [upgrades_special upgradeActions:newID];
